...
@endphp
@section('body')
<x-block class="container-fluid line-b navbar-fixed-top navbar-light">
...
<x-layout.simple data-open="click" data-menu="vertical-menu" data-col="2-columns" class="bg-white vertical-layout vertical-menu 2-columns  container boxed-layout fixed-navbar" />