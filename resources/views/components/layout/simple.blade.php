...
<head>
  ...
  @stack('meta')
  <link rel="shortcut icon" type="image/jpg" href="{{asset('theme/images/logo/ico.png')}}" />
  <link rel="icon" type="image/jpg" href="{{asset('theme/images/logo/ico.png')}}" />

  <title>@yield('page-title', 'KingPang')</title>
  @livewireStyles
  <link href="{{asset('theme/css/app.css')}}?t={{time()}}" rel="stylesheet">
  @stack('css')
</head>
