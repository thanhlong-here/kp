...
<?php $component->withAttributes(['class' => 'container-fluid bg-white sticky-wrapper line-b']); ?>
  <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.layout.inc.header.post','data' => ['category' => $category]]); ?>
<?php $component->withName('layout.inc.header.post'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
...
<?php endif; ?>  
  ...
  <div class="container">
    <?php if(isset( $banner->avatar)): ?>
    <a href="<?php echo e(isset($banner->link) ? url($banner->link) : '#'); ?>">
      <img src="<?php echo e(asset($banner->avatar->src)); ?>" class="img-fluid"/>
    </a>  
    <?php endif; ?>
  </div>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH D:\www\kp\resources\views/components/layout/post.blade.php ENDPATH**/ ?>