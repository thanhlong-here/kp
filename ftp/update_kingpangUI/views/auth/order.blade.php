        ...
        <div class="card">
            ...
            <blockquote class="border-left-amber border-left-3 mt-1">
                <ul>
                    ...
                    <li>
                        Phiếu xác nhận thanh toán phát hành nhằm mục đích chứng minh giao dịch hoàn tất, không có giá trị
                        khi quyết toán thuế nhà nước
                    </li>
                </ul>
            </blockquote>
        </div>
