    ...
    <div class="main-menu menu-fixed menu-light">
        <div class="main-menu-content menu-accordion">
            <div class="card-block text-xs-center">
                @if ($user->avatar)
                    <img src="{{ url($user->avatar->src) }}" class="rounded-circle img-border width-100 height-100" />
                @else
                    <img src="{{ url('vendor/me/images/portrait/small/avatar-s-8.png') }}"
                ...
                <div class="mt-1">
                    ...
                    @if ($user->freelancer)
                        <a href="{{ route('freelancer.index') }}" class="mt-1 btn btn-info btn-block"> <i
            ...
            <div class="modal-content">
                <form class="form" action="{{ route('users.update', $user) }}" method="post">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel2"><i class="fa fa-road2"></i>
                            {{ Str::title(__('edit profile')) }}</h4>
                    </div>
