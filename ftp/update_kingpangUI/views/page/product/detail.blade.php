...
$tabs = ['description', 'portfolio', 'price', 'recommendations', 'review'];
@endphp
...
@section('side')
    <div class="card ">
        ...
        <div class="card-footer text-xs-center">
            <x-button.contact id="{{ $freelancer->id }}" class="btn btn-block btn-secondary"
                out="{{ Theme::title('contact consultant') }}" />
        </div>
    </div>
