@php
$list = App\Models\Block::pull('join.comunity', 'list')
    ->orderByDesc('priority')
    ->get();
$banner = App\Models\Block::pull('king.join')
    ->orderByDesc('priority')
    ->first();
                    ...
                    <div class="row match-height">
                        @foreach ($chunk as $item)
                            ...
                            <div class="col-md-3">
                                ...
                                @else
                                    <div @if ($item->avatar) data-bg-img="{{ url($item->avatar->src) }}" @endif class="lazy card popular">
