...
<div class="p-2 profile-card-with-cover text-xs-center">
    <div class="card-profile-image mb-2">
        <img src="{{ $avatar }}" loading='lazy'
            class="width-100 height-100 rounded-circle img-border box-shadow-1" alt="Freelancer">
    </div>
    <a class=" btn btn-primary btn-sm btn-block" href="{{ $route }}">
        <i class="fa fa-exchange"></i>
        <span class="text-bold-600 font-medium-1"> {{ Theme::title('freelancer') }} </span> </span>
    </a>
</div>
...
<ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
    ...
    <li class="nav-item has-sub sub-order has-sub">
        ...
        <ul class="menu-content">
            ...
            <li class="nav-item">
                <a href="{{ route('auth.orders', ['user' => $user, 'status' => 'order', 'open' => 'order']) }}"
                    class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('auth.orders', ['user' => $user, 'status' => 'paid', 'open' => 'order']) }}"
                    class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('auth.orders', ['user' => $user, 'status' => 'pending', 'open' => 'order']) }}"
                    class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('auth.orders', ['user' => $user, 'status' => 'process', 'open' => 'order']) }}"
                    class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('auth.orders', ['user' => $user, 'status' => 'edit', 'open' => 'order']) }}"
                    class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('auth.orders', ['user' => $user, 'status' => 'finish', 'open' => 'order']) }}"
                    class="nav-link">
                    <span class="menu-title">{{ Theme::title('finish') }} </span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('auth.orders', ['user' => $user, 'status' => 'needreview', 'open' => 'order']) }}"
                    class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('auth.orders', ['user' => $user, 'status' => 'cancel', 'open' => 'order']) }}"
                    class="nav-link">
